...
### 前端 (Frontend)
- **URL**: https://www.zjmqy.cc
- **状态**: ✅ 正常运行
- **容器**: manqiyou-frontend
- **端口**: 127.0.0.1:3001 → 3000

### 后端 (Backend)
- **API URL**: https://www.zjmqy.cc/api
- **状态**: ✅ 正常运行
- **容器**: manqiyou-backend
...
- **问题**: API 请求失败，CORS 头显示 `'https://zjmqy.cc, *'`
- **原因**: CORS 配置重复导致头部值重复
- **解决**: 
...
```bash
# 测试 API 端点
$ curl -s https://www.zjmqy.cc/api/routes | jq '.code, .message, (.data.records | length)'
200
"success"
6
