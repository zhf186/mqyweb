...
export default function CareersPage() {
  ...
  React.useEffect(() => {
    getPageContent('careers').then((content) => {
      ...
      <main className="bg-black text-white">
        <section className="mx-auto max-w-4xl px-6 py-24">
          <h1
            ...
            data-editable="careersPage.title"
            data-editable-type="text"
            data-editable-label="Careers Page Title"
          >
            {getEditableText('careersPage.title', t('footer.links.careers', '加入我们'))}
          </h1>
          <p
            className="mt-6 text-white/70"
            data-editable="careersPage.desc"
            data-editable-type="text"
            data-editable-label="Careers Page Description"
          >
            {getEditableText('careersPage.desc', t('common.comingSoon', '页面建设中，敬请期待。'))}
          </p>
          <div className="mt-10">
            <Link
              ...
              data-editable-type="text"
              data-editable-label="Careers Back Home"
            >
              {getEditableText('careersPage.backHome', t('common.backHome', '返回首页'))}
            </Link>
          </div>
        </section>
        <Footer />
