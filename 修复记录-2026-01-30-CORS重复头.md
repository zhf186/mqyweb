...
浏览器访问 https://www.zjmqy.cc/routes 时，API 请求失败，控制台报错：
...
CORS 响应头被重复添加，导致 `Access-Control-Allow-Origin` 的值变成了 `'https://zjmqy.cc, *'` 而不是单一值。
...
- ✅ Routes 页面正常加载数据
- ✅ 所有 API 端点 CORS 正常
- ✅ 支持 www.zjmqy.cc 和 zjmqy.cc 两个域名
