...
SELECT '关于我们页面图片添加完成 - 2张' AS status;
...
SELECT 'E-BIKE页面图片添加完成 - 9张' AS status;

-- ============================================
-- 4. 骑行路线 (routes) - 根据实际使用情况添加
-- ============================================
-- 保持现有的10张图片

-- ============================================
-- 5. 在地好物 (goods) - 根据实际使用情况添加
-- ============================================
-- 保持现有的12张图片

-- ============================================
-- 6. 社群活动 (community) - 20张图片
-- ============================================
INSERT INTO cms_assets (category, original_filename, file_key, file_url, file_size, width, height, mime_type, alt_text_zh, alt_text_en, is_processed, webp_converted, processing_status, uploaded_by, created_at, updated_at)
VALUES 
...
SELECT '社群活动页面图片添加完成 - 20张' AS status;

-- ============================================
-- 7. 合作伙伴 (partners) - 根据实际使用情况添加
-- ============================================
-- 保持现有的14张图片
