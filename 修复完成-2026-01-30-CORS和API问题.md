...
### 问题 2: CORS 头重复
- **现象**: 浏览器报错 `Access-Control-Allow-Origin: https://zjmqy.cc, *`
...
# access-control-allow-origin: https://www.zjmqy.cc ✅
# access-control-allow-credentials: true ✅
```

#### /api/goods (预期 403)
```bash
curl -I https://www.zjmqy.cc/api/goods
# HTTP/2 403 ⚠️
```
