...
浏览器控制台出现以下 404 错误：
```
GET https://zjmqy.cc/community/events?_rsc=1bcxv 404 (Not Found)
GET https://zjmqy.cc/goods/1?_rsc=2ckqr 404 (Not Found)
GET https://zjmqy.cc/goods/2?_rsc=2ckqr 404 (Not Found)
GET https://zjmqy.cc/goods/3?_rsc=2ckqr 404 (Not Found)
```
...
# 测试页面是否可访问
curl -I https://www.zjmqy.cc/community/events
curl -I https://www.zjmqy.cc/goods/1
```
...
echo "=== 部署完成 ==="
echo "请访问以下页面验证："
echo "  - https://www.zjmqy.cc/community/events"
echo "  - https://www.zjmqy.cc/goods/1"
EOF
